...
class Engine:
	...
	def __init__(self, *args, **kwargs):
		...
		self.screenSize = (pygame.display.Info().current_w-400, pygame.display.Info().current_h-300)
	...
	def drawAll(self):
		...
		if(self.torchMode):
			#drawImage.fill((0, 128, 0), None, pygame.BLEND_ADD) # Green
			drawImage.fill((93, 113, 164), None, pygame.BLEND_ADD) # Blue
